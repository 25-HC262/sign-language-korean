...
mkdir -p "${MODEL_DIR}/fine-tunning"
gsutil cp gs://trout-models/fine-tunning/ksl_asl_stage3.keras \
  "${MODEL_DIR}/fine-tunning/ksl_asl_stage3.keras"
...
docker run -d \
  ...
  -e KSL_FINETUNE_MODEL=models/fine-tunning/ksl_asl_stage3.keras \
  -e KSL_VISUALIZE=1 \
