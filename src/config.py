...
# 로컬 베이스는 항상 필요
L_DATA, L_UMAP, L_GM, L_CKPT, L_TEST, L_TOOLS, L_PREPROCESSED_DATA = (PROJECT_ROOT / p for p in base_map['L'])
...
LOAD_DATA, LOAD_UMAP, LOAD_GM, _, LOAD_TEST, LOAD_TOOLS, LOAD_PREPROCESSED_DATA = base_map.get(UPLOAD_MODE, base_map['L'])
